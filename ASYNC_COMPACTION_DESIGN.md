...
```ts
compact(preparation, model, apiKey, headers, undefined, signal, thinkingLevel, undefined, env)
```
...
- resolved request headers and environment from Pi's model registry
